/* src/pages/Home.js (Updated layout for side-by-side sections) */
...
import './Home.css'; // Page-specific styles if needed
...
function Home() {
    ...
    return (
        <div className="home-container">
            ...
            <section className="input-controls-wrapper">
                ...
                <div className="plotting-controls-section card">
                    <PlottingControls
